...
##Partition
Training Data was split into 70% training and 30% testing so that I can test my model for accuracy.
...
##Prediction
I tested the fitness model function classeFit on the probe dataset as such. Then, I generated the confusion matrix for that prediction to evaluate the misclassification or out-of-sample error.  
